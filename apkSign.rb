module Fastlane
  module Actions
    ...
    class SignApkAction < Action
      ...
      sign_cmd = ["apksigner sign --verbose --v1-signing-enabled true --v2-signing-enabled true"]
      sign_cmd << ["--ks #{params[:keystore_path]}" ] if params[:keystore_path]
      ...
      def self.description
        "Sign a Android apk with by apksigner with keystore certificate"
      end
